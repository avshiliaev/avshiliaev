...
1. [A sample implementation of a online bank app: Microservices, CQRS, Domain-Driven Design, REST, Event-Driven.](https://github.com/avshiliaev/unicorn-bank-example-app)
